...
export default function App(){ 
  ...
  return (<div className="app">
    <header><div className="logo">CZ</div><div><h1>Cleanzup - Cleaner</h1><div className="muted">Nellore demo</div></div></header>
    <div className="card">
      ...
      {view==='home' && <div>Welcome to Cleanzup (Cleaner)</div>}
